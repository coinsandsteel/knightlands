<template>
  <div class="flex flex-items-center flex-column">
    ...
    <div class="margin-top-2 relative selector-content" @click="select" :class="{show: value == className}">
      ...
      <div class="params panel-dark relative margin-top-4">
        ...
        >
          <IconWithValue iconClass="icon-energy">
              <IconWithValue valueClass="font-size-15 blue-title" :flip="true" iconClass="icon-timer small">
                  {{energyRegen}}
             </IconWithValue>
          </IconWithValue>
