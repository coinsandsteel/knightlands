    ...
    >
      <div class="flex flex-column color-panel-2 font-size-22">
        <div
          ...
          :class="{ selectedNetwork: preselectedNetwork == c }"
        >
...
export default {
  ...
  methods: {
    ...
    confirmNetwork() {
      this.selectedNetwork = this.preselectedNetwork;
      this.$emit("input", this.preselectedNetwork);
